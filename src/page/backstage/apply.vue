<template>
    <div class="table">
        ...
        <el-table :data="tableData" border style="width: 100%"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="user_isValidate" label="域名"  width="140">
            </el-table-column>
            <el-table-column prop="user_isValidate1" sortable label="联系人"  width="140">
            </el-table-column>
            <el-table-column prop="user_isValidate2" label="手机"  width="140">
            </el-table-column>
            <el-table-column prop="user_isValidate2" label="状态"  width="140">
            </el-table-column>
            <el-table-column prop="user_register_time" label="申请日期" sortable width="160" :formatter="formatter">
            </el-table-column>
