      ...
      <div style="font-size: 20px;height: 30%;width:60%;margin-left:15%;">
          <el-form :model="article" :rules="rules" ref="article" label-width="0px" style="height: 60%"  >
                <el-form-item prop="title">
                    <el-input v-model="article.title" placeholder="职位名称" ></el-input>
                </el-form-item>
                <el-form-item prop="title">
                    <el-input v-model="article.title" placeholder="发布者" ></el-input>
                </el-form-item>
            <el-form-item prop="title">
                <template>
                  <el-radio class="radio" v-model="radio" label="1">发布</el-radio>
                  <el-radio class="radio" v-model="radio" label="2">不发布</el-radio>
                </template>
            </el-form-item>
            <el-form-item prop="title">
                 <el-date-picker
                ...
                <div class="handleArticleClass" >
                    ...
                    <el-button class="editor-btn" type="primary" @click="save('article',1)">添加</el-button>
