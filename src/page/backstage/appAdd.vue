<template>
    <div style="height: 100%">
      ...
      <div style="font-size: 20px;height: 30%;width:60%;margin-left:15%;">
          <el-form :model="app" :rules="rules" ref="app" label-width="15%" style="height: 80%"  >
                <el-form-item prop="name" label="应用名称">
                    <el-input v-model="app.name" placeholder="应用名称" ></el-input>
                </el-form-item>
                <el-form-item prop="size" label="应用大小">
                    <el-input v-model="message.describe" placeholder="应用大小" ></el-input>
                </el-form-item>
            ...
            <div class="handleArticleClass" >
                    <el-button class="editor-btn" type="primary" @click="saveForm('app')">发布</el-button>
                    <el-button class="editor-btn" type="primary" @click="resetForm('app')">重置</el-button>
                </div>
            </el-form>
      </div>
    </div>
