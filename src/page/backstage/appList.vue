<template>
    <div class="table">
        ...
        <el-table :data="tableData" border style="width: 100%"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="user_isValidate" sortable label="大小"  width="100">
            </el-table-column>
            <el-table-column prop="user_isValidate" label="地址"  width="80">
            </el-table-column>
            <el-table-column prop="user_isValidate" sortable label="下载量"  width="100">
            </el-table-column>
            <el-table-column prop="user_isValidate2" label="是否显示"  width="140">
            </el-table-column>
            <el-table-column prop="user_isValidate1" sortable label="排序号"  width="140">
            </el-table-column>
            <el-table-column prop="user_register_time" label="发布日期" sortable width="160" :formatter="formatter">
            </el-table-column>
