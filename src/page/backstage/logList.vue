<template>
    <div class="table">
        ...
        <el-table :data="tableData" border style="width: 100%"  @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="user_isValidate"  label="IP"  width="100">
            </el-table-column>
            <el-table-column prop="user_isValidate" label="操作项"  width="80">
            </el-table-column>
            <el-table-column prop="user_isValidate"  label="操作内容"  >
            </el-table-column>
            <el-table-column prop="user_isValidate2" label="状态"  width="140">
            </el-table-column>
            <el-table-column prop="user_register_time" label="操作时间" sortable width="160" :formatter="formatter">
            </el-table-column>
        </el-table>
