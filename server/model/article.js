...
class Article {
    ...
    static save(article) {
        return db.exec(sqls.insertArticle, [article.title, article.create_time, article.release_time, article.ip, article.readerCount, article.category,
    ...
    static updateAtricle(article) {
        return db.exec(sqls.updateArticle, [article.title, article.create_time, article.release_time, article.ip, article.readerCount, article.category,
            article.userId, article.typeId, article.articalType, article.content, article.articleBrief, article.articleMainImage,
